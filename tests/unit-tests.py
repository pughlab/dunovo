...
make_tests(GetAlignmentErrorsTest, suite=errstatsTests, data=(
    ...
    {'consensus':  'GATTACA', 'qual_thres':0, 'count_indels':True,
     'seq_align': ('GATTACA',
                   'GATCACA'), 'name':'Snv',
     'qual_align':('IIIIIII',
                   'IIIIIII'), 'errors':[{'alt':'C', 'coord':4, 'seq':1, 'type':'SNV'}]},
    {'consensus':  'GATTACA', 'qual_thres':0, 'count_indels':True,
     'seq_align': ('GATTACA',
                   'GAT-ACA'), 'name':'Del',
     'qual_align':('IIIIIII',
                   'III III'), 'errors':[{'alt':1, 'coord':3, 'seq':1, 'type':'del'}]},
    {'consensus':  'GAT-ACA', 'qual_thres':0, 'count_indels':True,
     'seq_align': ('GAT-ACA',
                   'GATTACA'), 'name':'Ins',
     'qual_align':('IIIIIII',
                   'III III'), 'errors':[{'alt':'T', 'coord':3, 'seq':1, 'type':'ins'}]},
    {'consensus':  'GATTACA', 'qual_thres':0, 'count_indels':False,
     'seq_align': ('GATTAGA',
                   'GAT-ACA'), 'name':'NoCountIndels',
     'qual_align':('IIIIIII',
                   'III III'), 'errors':[{'alt':'G', 'type':'SNV', 'coord':6, 'seq':0}]},
    ...
    {'consensus':  'GATTWCA', 'qual_thres':0, 'count_indels':True,
     ...
     'qual_align':('IIIIIII',
                   'III III'), 'errors':[{'alt':1, 'type':'del', 'seq':1, 'coord':3}]},
    {'consensus':  'GATTACA', 'qual_thres':30, 'count_indels':True,
     'seq_align': ('GATTCCA',
                   'GATGACA'), 'name':'QualSnv',
     'qual_align':('IIIIIII',
                   'III+III'), 'errors':[{'alt':'C', 'type':'SNV', 'seq':0, 'coord':5}]},
    {'consensus':  'GATTACA', 'qual_thres':30, 'count_indels':True,
     'seq_align': ('GATTCCA',
                   'GAT-ACA'), 'name':'QualDel',
     'qual_align':('IIIIIII',
                   'II+ +II'), 'errors':[{'alt':'C', 'type':'SNV', 'seq':0, 'coord':5}]},
    {'consensus':  'GATTACA', 'qual_thres':30, 'count_indels':True,
     'seq_align': ('GATTACA',
                   'GAT-GCA'), 'name':'QualDelSnv',
     'qual_align':('IIIIIII',
                   'II+ I+I'), 'errors':[{'alt':'G', 'type':'SNV', 'seq':1, 'coord':5}]},
    {'consensus':  'GATTACA', 'qual_thres':0, 'count_indels':True,
     'seq_align': ('GATTACA',
                   'GAT---A'), 'name':'LongDel',
     'qual_align':('IIIIIII',
                   'III   I'), 'errors':[{'alt':3, 'type':'del', 'seq':1, 'coord':3}]},
    {'consensus':  'GAT---A', 'qual_thres':0, 'count_indels':True,
     'seq_align': ('GATTACA',
                   'GAT---A'), 'name':'LongIns',
     'qual_align':('IIIIIII',
                   'III   I'), 'errors':[{'alt':'TAC', 'type':'ins', 'seq':0, 'coord':3}]},
    {'consensus':  'GATTACA', 'qual_thres':30, 'count_indels':True,
     'seq_align': ('GATTACA',
                   'GAT-CCA'), 'name':'SnvAfterDel',
     'qual_align':('IIIIIII',
                   'III III'), 'errors':[{'alt':1, 'type':'del', 'seq':1, 'coord':3},
                                         {'alt':'C', 'type':'SNV', 'seq':1, 'coord':5}]},
    {'consensus':  'GATTACA', 'qual_thres':30, 'count_indels':True,
     'seq_align': ('GATTACA',
                   'GAT-CCA'), 'name':'QualAfterDel',
     'qual_align':('IIIIIII',
                   'III +II'), 'errors':[{'alt':1, 'type':'del', 'seq':1, 'coord':3}]},
    {'consensus':  'GATTAC-', 'qual_thres':30, 'count_indels':True,
     'seq_align': ('GATTAC-',
                   'GATTACA'), 'name':'EndIns',
     'qual_align':('IIIIIII',
                   'IIIIII '), 'errors':[{'alt':'A', 'type':'ins', 'seq':1, 'coord':6}]},
  )
)
